...
export default function Home() {
  return (
    <>
      <Row>
        <Col>
          <Image src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" alt="Met building"  fluid rounded></Image>
          <br/><br/>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col md={6}>
          ...
          <p>
          <a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">Reference</a>
          </p>
        </Col>
      </Row>
    </>
